...
import { ProfessionAreaDTO } from '../model/professionAreaDTO';
...
@Injectable()
export class ProfessionAreaService {
    ...
    public apiProfessionAreaIdDelete(id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling apiProfessionAreaIdDelete.');
        }
    ...
    public apiProfessionAreaIdGet(id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling apiProfessionAreaIdGet.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiProfessionAreaIdPut(id: string, body?: ProfessionAreaDTO, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public apiProfessionAreaIdPut(id: string, body?: ProfessionAreaDTO, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public apiProfessionAreaIdPut(id: string, body?: ProfessionAreaDTO, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public apiProfessionAreaIdPut(id: string, body?: ProfessionAreaDTO, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling apiProfessionAreaIdPut.');
        }
        ...
        return this.httpClient.request<any>('put',`${this.basePath}/api/ProfessionArea/${encodeURIComponent(String(id))}`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
