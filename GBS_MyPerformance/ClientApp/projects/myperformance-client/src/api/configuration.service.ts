...
export class ConfigurationService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiConfigurationIdPut(id: string, body?: ConfigurationDTO, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public apiConfigurationIdPut(id: string, body?: ConfigurationDTO, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public apiConfigurationIdPut(id: string, body?: ConfigurationDTO, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public apiConfigurationIdPut(id: string, body?: ConfigurationDTO, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling apiConfigurationIdPut.');
        }
        ...
        return this.httpClient.request<any>('put',`${this.basePath}/api/Configuration/${encodeURIComponent(String(id))}`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
