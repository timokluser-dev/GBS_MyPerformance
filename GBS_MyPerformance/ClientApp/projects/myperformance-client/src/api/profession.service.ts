...
import { ProfessionDTO } from '../model/professionDTO';
...
export class ProfessionService {
    ...
    public apiProfessionIdDelete(id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling apiProfessionIdDelete.');
        }
    ...
    public apiProfessionIdGet(id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling apiProfessionIdGet.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiProfessionIdPut(id: string, body?: ProfessionDTO, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public apiProfessionIdPut(id: string, body?: ProfessionDTO, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public apiProfessionIdPut(id: string, body?: ProfessionDTO, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public apiProfessionIdPut(id: string, body?: ProfessionDTO, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling apiProfessionIdPut.');
        }
        ...
        return this.httpClient.request<any>('put',`${this.basePath}/api/Profession/${encodeURIComponent(String(id))}`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
